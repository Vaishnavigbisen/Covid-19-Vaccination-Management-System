        ...
        <div class="row">
            <div class="col-md-12">
                <p id="about1">
                    ...
                    ABOUT THE DISEASE CORONAVIRUS (COVID-19) COVID-19 is a new illness that can
                    affect your lungs and airways.It'scaused by a virus called coronavirus.It
                    was
                    ...
                    of
                    breath and breathing difficulties.<br><br>
                    In more severe cases,infection can cause pneumonia,severe acute respiratory
                    syndrome,Kidney failure and even death.<br><br>
                    ...
                    cooking<br><br>
                    meat and eggs.Avoid close contact with anyone showing symptoms of
                    respiratory
                    illness such as coughing and sneezing.<br><br><br><br><br>
                </p>
            </div>
        </div>
    </div>
